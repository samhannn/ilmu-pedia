...
<div class="max-w-7xl mx-auto px-6 py-8">
    ...
    <div class="flex flex-col md:flex-row justify-between items-center mb-8">
        <div class="text-sm font-bold text-gray-500 mb-4 md:mb-0">
            ...
            <a href="{{ route('dashboard') }}" class="hover:underline">Dashboard</a> > <span class="text-blue-500">Daftar Modul</span>
        </div>
        
        <a href="{{ route('modul.create') }}" class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-6 rounded-full shadow-md transition transform hover:scale-105 flex items-center gap-2">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="bg-white rounded-2xl border border-gray-200 shadow-sm hover:shadow-md transition overflow-hidden flex flex-col">
            ...
            <div class="p-5 flex-grow flex flex-col">
                <h3 class="font-bold text-lg text-gray-800 mb-2 line-clamp-1">{{ $modul->judul }}</h3>
                ...
                <div class="flex gap-2 mt-auto">
                    <a href="{{ route('modul.edit', $modul->id) }}" class="flex-1 bg-blue-100 text-blue-600 text-center py-2 rounded-lg font-bold hover:bg-blue-200 transition text-sm">
                        Edit / Detail
                    </a>

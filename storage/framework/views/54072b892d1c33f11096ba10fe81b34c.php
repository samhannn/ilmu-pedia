<footer class="bg-white py-6 md:py-8 border-t border-gray-100">
        <div class="max-w-[1440px] mx-auto px-6 md:px-12 flex justify-between items-center">
            
            <div class="font-bold text-xs md:text-sm text-black">
                Footer
            </div>

            <div class="flex gap-3 md:gap-4">
                <a href="#" class="text-[#7dd3fc] hover:text-blue-400 transition">
                    <svg class="w-5 h-5 md:w-6 md:h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"></path></svg>
                </a>
                <a href="#" class="text-[#7dd3fc] hover:text-blue-400 transition">
    ...
    </footer><?php /**PATH C:\Users\Acer\Documents\ilmu-pedia\resources\views/partials/footer.blade.php ENDPATH**/ ?>
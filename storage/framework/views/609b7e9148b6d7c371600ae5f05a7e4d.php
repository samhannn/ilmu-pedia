<nav class="w-full bg-white py-1 md:py-2 shadow-sm z-50 relative">
    <div class="max-w-7xl mx-auto px-6 md:px-12 flex justify-between items-center">
        ...
        <a href="<?php echo e(route('dashboard')); ?>" class="flex items-center">
            <img src="<?php echo e(asset('img/logo.png')); ?>" alt="Logo" class="h-8 md:h-10 w-auto object-contain">
        </a>
...
</script><?php /**PATH C:\Users\Acer\Documents\ilmu-pedia\resources\views/partials/navbar.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="max-w-4xl mx-auto px-6 -mt-10 mb-20">
        <div class="grid grid-cols-2 md:grid-cols-3 gap-6">
            ...
            <a href="<?php echo e(route('modul.create')); ?>" class="group bg-gray-200 hover:bg-white border-2 border-transparent hover:border-blue-300 rounded-xl p-6 flex flex-col items-center justify-center shadow-sm hover:shadow-lg transition cursor-pointer aspect-square">
            ...
            <a href="<?php echo e(route('modul.index')); ?>" class="group bg-gray-200 hover:bg-white border-2 border-transparent hover:border-blue-300 rounded-xl p-6 flex flex-col items-center justify-center shadow-sm hover:shadow-lg transition cursor-pointer aspect-square">
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Acer\Documents\ilmu-pedia\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>
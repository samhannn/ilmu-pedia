    ...
    <div class="bg-[#67c3f3] rounded-b-[40px] md:rounded-b-[60px] pt-8 pb-12 px-6 relative overflow-hidden z-20">
        <div class="max-w-7xl mx-auto relative z-10 flex flex-col md:flex-row items-start justify-between">
            ...
            <div class="absolute -right-6 top-6 md:static md:w-1/2 flex md:justify-end pointer-events-none z-10">
                <img src="<?php echo e(asset('img/planet.png')); ?>" alt="Background Planet" class="w-[180px] md:w-[360px] h-auto object-contain opacity-90 md:opacity-100 transform rotate-12">
            </div>
        </div>
    </div>
        ...
        <div class="max-w-5xl mx-auto px-6 md:px-8">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-8 lg:gap-12">
                <?php $__empty_1 = true; $__currentLoopData = $moduls; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $modul): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <a href="<?php echo e(route('user.modul.show', $modul->slug)); ?>" class="flex flex-col group cursor-pointer relative z-30">
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Acer\Documents\ilmu-pedia\resources\views/user/dashboard.blade.php ENDPATH**/ ?>